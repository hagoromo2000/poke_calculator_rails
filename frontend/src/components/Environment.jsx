    ...
    <>
      <div className="artboard phone-6 bg-white rounded-lg shadow-xl mx-auto mt-10 ">
        ...
        <div className="flex">
          ...
          <select id="underline_select" className="ml-2 mr-2 block py-2.5 px-0 w-full text-sm text-gray-800 bg-transparent border-0 border-b-2 border-gray-400 appearance-none dark:text-gray-400 dark:border-gray-700 focus:outline-none focus:ring-0 focus:border-gray-200 peer">
