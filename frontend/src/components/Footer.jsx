        ...
        <div className="w-full">
          ...
          <div className='w-full flex justify-center'>
            <div className="w-11/12 bg-gray-200 rounded-full dark:bg-gray-700 mt-4">
              <div className="bg-blue-600 text-xs font-medium text-blue-100 text-center p-0.5 leading-none rounded-full" style={{width: `${100-(minDamage / props.hp * 100)}%`}}>
                {(100 - (minDamage / props.hp * 100)).toFixed(1)}%
              </div>
            </div>
          </div>
          <div className='w-full'>
